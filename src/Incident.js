...
function updateEnergy(){
    ...
    var timeoffset = temptime - clocklastTime;
    clocklastTime = temptime;
    game.energy=game.energy-0.01 * timeoffset;
    //game.distance += game.speed*deltaTime*game.ratioSpeedDistance;
    fieldDistance.innerHTML =parseInt(game.energy);
    dis=parseInt(FlyDis);
    disinfo.innerHTML =dis;
    if (game.energy <1){
...
function initEventHandlers(canvas, pilotAngle) {
    ...
    scoreinfo = document.getElementById("scoreMessage");
    disinfo = document.getElementById("scoValue");
